...
# Returns : a number
def calcRoomSquareFootage(shape):
    ...
    if(roomShape == rectangle):
                rectSideLength1 = int(input("What is the length of the first dimension? "))
                rectSideLength2 = int(input("What is the length of the second dimension? "))
...
def main():
    ...
    for x in range(1, numberOfRooms + 1):
        roomShape = input("What is the shape of room", x, ", square or rectangle? ")
        return roomShape
